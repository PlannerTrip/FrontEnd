...
const PlaceInformation = ({ navigation, route }: Props) => {
  ...
  // display
  const [placeInformationStatus, setPlaceInformationStatus] = useState(LOADING);
  ...
  const [displayModalCheckInFail, setDisplayModalCheckInFail] = useState(false);
        ...
        >
          ...
          <View className="p-[16px] ">
            ...
            <View className="flex flex-col mt-[16px] ">
              ...
              {checkIn ? (
                <ButtonCustom title="เคยเช็กอินแล้ว" disable={true} />
              ) : (
                <ButtonCustom
                  title="เช็กอิน"
            ...
            <View>
              <View className="mt-[16px] ">
                <Text className="text-[16px] font-bold">รีวืวสถานที่</Text>
                <View className="flex flex-row mt-[8px]">
                  ...
                  <View className="ml-[8px] flex flex-grow">
                    <PercentageBar
                      starText={5}
                      percentage={handlePercentage(ratingCounts[5])}
                    />
                    <PercentageBar
                      starText={4}
                      percentage={handlePercentage(ratingCounts[4])}
                    />
                    <PercentageBar
                      starText={3}
                      percentage={handlePercentage(ratingCounts[3])}
                    />
                    <PercentageBar
                      starText={2}
                      percentage={handlePercentage(ratingCounts[2])}
                    />
                    <PercentageBar
                      starText={1}
                      percentage={handlePercentage(ratingCounts[1])}
                    />
                  </View>
                </View>
              ...
              <View className="mt-[16px] border-t-[0.5px] border-[#ABABB4]">
                {reviews &&
                  ...
                  reviews.map((review, index) => {
                    if (!deletedReview.includes(review.reviewId)) {
                      return (
                        <Review
                          key={index}
